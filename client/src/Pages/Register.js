                ...
                <Form className="col-lg-8" onSubmit={handleSubmitReg}>
                    ...
                    <Form.Row>
                        <Form.Group controlId="forName" className="col-lg-8">
                            ...
                            <Form.Control type="text" name="name" placeholder="" onChange={handleChanges} required />
                            <Form.Text muted>
                    ...
                    <Form.Row>
                        <Form.Group controlId="formBasicEmail" className="col-lg-12">
                            ...
                            <Form.Control type="email" name="email" placeholder="" onChange={handleChanges} required />
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
                        <Form.Group controlId="formBasicAddress" className="col-lg-12">
                            <Form.Label>Home Address *</Form.Label>
                            <Form.Control type="add" name="add" placeholder="" onChange={handleChanges} required />
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
