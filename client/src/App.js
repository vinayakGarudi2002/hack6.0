...
import Fcreatesell from './Fcreatesell';
   ...
   return (
      <>
         ...
         <Switch>
            ...
            <Route
  path="/add-product"
  render={() => <CreateSell prams={changeTheNumber} />}
/>

{/* <Route path="/add-product" element={<CreateSell prams={changeTheNumber}  />} /> */}
